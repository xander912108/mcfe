...
export default function InsightsPage() {
  ...
  return <main className="flex-1 min-w-0 space-y-5 pb-8">
    ...
    <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_340px]"><div className="space-y-5">
